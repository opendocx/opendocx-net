...
2. Push to NuGet:
   ```bash
   dotnet nuget push bin/Release/OpenDocx.NET.1.1.4.nupkg --api-key YOUR_API_KEY_HERE --source https://api.nuget.org/v3/index.json
   ```
...
- **Symbol Package**: `OpenDocx.NET.1.1.4.snupkg` - Debug symbols for easier debugging
